...
namespace TreeViewer.Core.ProjectData
{
    ...
    public class ProjectData
    {
        ...
        public static ProjectData Load(Stream stream)
        {
            ...
            if (rootData.Version != DataFormatVersion) throw new NotSupportedException("サポートされていないデータのバージョンです。https://github.com/Funny-Silkie/TreeViewer/blob/master/README.md を確認ください");
